...
(function (global, factory) {
  ...
  */
  ...
  const EVENT_KEYDOWN_DISMISS$2 = `keydown.dismiss${EVENT_KEY$4}`;
  ...
  class Toast extends BaseComponent {
    ...
    _setListeners() {
      ...
      EventHandler.on(this._element, EVENT_FOCUSOUT, event => this._onInteraction(event, false)); // add esc event to close toast
